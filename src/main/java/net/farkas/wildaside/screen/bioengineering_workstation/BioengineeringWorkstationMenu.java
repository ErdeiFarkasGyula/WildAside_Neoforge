...
public class BioengineeringWorkstationMenu extends AbstractContainerMenu {
    ...
    public BioengineeringWorkstationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 0, 44, 34));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 1, 44, 16));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 2, 62, 34));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 3, 44, 52));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 4, 26, 34));
        this.addSlot(new BioengineeringWorkstationResultSlot(blockEntity.itemHandler, 5, 130, 34, inv.player));
